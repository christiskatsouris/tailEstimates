...
The R package [‘tailEstimates’](https://github.com/christiskatsouris/tailEstimates) will be able to be installed from Github and [CRAN](https://cran.r-project.org/).
